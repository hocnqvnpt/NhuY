...
rollback;
rollback;
SELECT* FROM ttkd_Bsc.tl_giahan_tratruoc WHERE thang = 202405 and ma_nv = 'VNP016881'; LOAI_TINH= 'DONGIATRA_OB';
select* from ttkd_Bsc.ct_Dongia_Tratruoc  WHERE LOAI_TINH= 'DONGIATRA_OB' and thang = 202405;
select* from ttkd_Bsc.ct_Dongia_Tratruoc  WHERE LOAI_TINH= 'DONGIATRA_OB' and thang = 202405;
...
with tien as (
    ...
    where thang = 202405 and loai_tinh = 'DONGIATRA_OB'  and ipcc = 1--and ghichu = 'bo sung TB co chot, chua chi don gia, nhan vien xuat hoa don la nhan vien cap nhat chung tu, ty le thanh cong la ty le tien don gia xuat HD (TTCK)'
--    and ma_nv = 'VNP017247'
    union all
...
rollback;
insert into tl_giahan_tratruoc 
select 20240501 THANG, LOAI_TINH, MA_KPI, MA_NV, MA_TO, MA_PB, TONG, DA_GIAHAN_DUNG_HEN, DTHU_DUYTRI, DTHU_THANHCONG_DUNG_HEN, TYLE, TIEN, LDP_PHUTRACH, HESO_GIAO from ttkd_Bsc.tl_giahan_tratruoc where loai_tinh = 'DONGIATRA_OB' AND ma_pb = 'VNP0703000'
and thang = 202405;
delete from 
commit;
select lan_in from css_hcm.phieutt_hd;

...
commit;
rollback;
select* from ttkd_Bsc.bangluong_dongia_qldb where thang = 202402 
...
rollback;
    ----tao du lieu view tong quan cac gia KPI
            ...
            delete from backup_tonghop_dongia where thang = 202402;
            commit;
...
WHERE a.ma_kpi = 'HCM_LUONG_QLDB_054' and thang = 202402
;
                    rollback;
                    commit;
;  
...
WHERE a.ma_kpi = 'HCM_LUONG_QLDB_056' and thang = 202402
;
                     ----TO TRUONG
update backup_tonghop_dongia a 
set giatri = (select round(sum(heso_giao), 0) from ttkd_bsc.tl_giahan_tratruoc
                                    where MA_KPI in ('HCM_TB_GIAHA_022') and loai_tinh = 'KPI_TO' and thang = 202402 and a.ma_to = ma_to)
...
set giatri = ( select round(sum(a.heso_giao), 0) from ttkd_bsc.tl_giahan_tratruoc a
                            ...
                            where a.MA_KPI in ('HCM_TB_GIAHA_022') and a.loai_tinh = 'KPI_NV'
                                                and a.thang = 202402 and b.manv_pgd = a1.ma_nv
                     )
-- select * from backup_tonghop_dongia a1
WHERE a1.ma_kpi = 'HCM_LUONG_QLDB_056' and a1.thang = 202402
...
WHERE a.ma_kpi = 'HCM_LUONG_QLDB_057' and thang = 202402
;
                    select* from 
...
WHERE a1.ma_kpi = 'HCM_LUONG_QLDB_058' and a1.thang = 202402
; 
select* from backup_tonghop_dongia
                    ----TO TRUONG
update backup_tonghop_dongia a1
...
WHERE a.ma_kpi = 'HCM_LUONG_QLDB_059' and thang = 202402
;
commit;
...
WHERE a1.ma_kpi = 'HCM_LUONG_QLDB_060' and a1.thang = 202402
;
...
WHERE a1.ma_kpi = 'HCM_LUONG_QLDB_062' and a1.thang = 202402
;
                commit;
select *
                                            from ttkd_bsc.ct_dongia_tratruoc  a
...
;
select* from ttkd_bsc.nhanvien_202401 

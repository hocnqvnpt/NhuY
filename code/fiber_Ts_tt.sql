...
with t0 as (select c0.thuebao_id, c0.phieutt_id, c0.ma_gd, c0.rkm_id, c0.ngay_bd_moi, c0.tien_thanhtoan, c0.vat_thanhtoan vat
                                        , c0.ngay_tt, c0.ngay_hd, c0.ngay_nganhang, c0.soseri, c0.seri, c0.kenhthu, c0.ten_nganhang, c0.ten_ht_tra, c0.khachhang_id
...
select 202404 thang,  -1 gh_id, dbtb.ma_tb, a.thuebao_id, a.khachhang_id
...
--                left join c on a.thuebao_id = c.thuebao_id
            left join ttkd_bsc.nhanvien_202403 nv on a.MANV_THUYETPHUC = nv.ma_nv 
  ...
  insert into dongia_moi(THANG, LOAI_TINH, MA_KPI, THUEBAO_ID, MA_TB,ma_nv,ma_to,ma_pb,NHOMTB_MOI_ID,NHOMTB_CU_ID,  SOTHANG_DC, HT_TRA_ONLINE,
                ...
                select THANG, 'DONGIA_TS_TP_TT' LOAI_TINH, 'DONGIA' MA_KPI, THUEBAO_ID, ma_tb, MANV_THUYETPHUC, MA_TO, MA_PB, NHOMTB_ID, goi_old_id, SOTHANG_DC, HT_TRA_ONLINE,
...
--                                            left join  km on a.rkm_id = km.rkm_id
                        where a.thang = 202404 and a.rkm_id is not null AND A.MANV_tHUYETPHUC IS NOT NULL --and a.thang = 202403 and to_number(to_char(ngay_tt,'yyyymm'))  = 202403---        CHANGE
...
where ma_kpi = 'DONGIA' --and loaitb_id in (58,59)
            and loai_tinh in ('DONGIA_TS_TP_TT') and thang = 202404

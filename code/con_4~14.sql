...
,km as (select /*+result_cache*/ rkm_id, thuebao_id, ma_tb, loaitb_id, ngay_bddc,  ngay_ktdc, ngay_kt, ngay_huy, ngay_thoai
...
, km1 as    (select /*+result_cache*/ thuebao_id, thang_bd_mg, thang_kt_mg, rkm_id, thangkm
...
--                            and km.loaitb_id not  in (18, 58, 59, 61, 171, 210, 222, 224)                                                                                                
                          --  and km.thuebao_id = 9085442
    )  select 1 from dc where rownum = 1; ma_Tb = 'nhakhoaphuchau';
, tt1 as (

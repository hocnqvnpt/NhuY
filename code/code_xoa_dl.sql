...
create table tmp_ipcc as 
;
--xoa
delete from ttkd_Bsc.nhuy_ct_Bsc_ipcc_obghtt where thang = 202405 and to_number(to_char(ngay_tt,'yyyymmdd'))>= 20240602 and ht_Tra_id not in (2,4,5); 

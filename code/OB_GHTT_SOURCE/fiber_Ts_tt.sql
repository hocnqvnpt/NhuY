...
--                left join c on a.thuebao_id = c.thuebao_id
            ...
            select* from tmp3_tp;
            delete from ttkd_bsc.ct_bsc_Trasau_tp_tratruoc where thang = 202407;
            commit;
...
--                                            left join  km on a.rkm_id = km.rkm_id
                        where a.thang = 202406 and --a.rkm_id is not null AND -- don gia TP 

                        a.rkm_id is  null AND -- don gia TP 
      ...
      select* from  ttkd_Bsc.ct_bsc_trasau_tp_tratruoc where thang = 202406 and rkm_id is null;
...
where ma_kpi = 'DONGIA' --and loaitb_id in (58,59)
            and loai_tinh in ('DONGIA_TS_TP_TT') and a.thang = 202409 and b.ma_pb not in ('VNP0702300','VNP0702400','VNP0702500')

...
commit;
select* from ct_bsc_homecombo where thang = 202402 and loai_kpi like 'Fiber_%'-- and account_fiber in ('p105d_ktxdhyd','buivantuan' )
insert into ttkd_bsc.ct_bsc_homecombo
select 202402 thang, 'Fiber_moi' loai_KPI, account_fiber, loai_goi, a.ngay_dk ngay_dk_goi, hd.ngay_sd ngay_sd_fiber, hd.thuonghieu, mnv_tt, ma_to, ma_pb, hd.hdtb_id, hd.thuebao_id, hd.ctv_id, hd.hdkh_id, hd.tocdo_id, hd.goi_id
...
where a.thang = 202401 and trangthai_goi <> 'Huy' and a.account_fiber = hd.ma_tb      --change n, n-1------
        ...
        and not exists (select 1 from ttkd_bsc.ct_bsc_homecombo where thuebao_id = hd.thuebao_id and thang >=202401)     ---change n-1------
;
---Buoc 2----------CT2 Fiber Home hienhuu
select* from css_Hcm.bd_Goi_dadv where thuebao_id in (5960008,8805485)
insert into ttkd_bsc.ct_bsc_homecombo
select 202402 thang, 'Fiber_hh' loai_KPI, account_fiber, loai_goi, a.ngay_dk ngay_dk_goi, hd.ngay_sd ngay_sd_fiber, hd.thuonghieu, mnv_tt, ma_to, ma_pb, hd.hdtb_id, hd.thuebao_id, hd.ctv_id, hd.hdkh_id, hd.tocdo_id, hd.goi_id
    , null ghichu                                                                                           ----1-change----
--    , 'bsung n-1 ket goi, hoan cong n' ghichu                                                                                           ---or 2-change----
from ct_homecombo_2024 a
, (select hdgoi.ctv_id, hdgoi.goi_id, hdtb.hdtb_id, hdtb.thuebao_id, hdtb.ma_tb, hdtb.hdkh_id, td.tocdo_id, td.thuonghieu, db.ngay_sd
...
;
z
select ma_tb from ttkd_bsc.ct_bsc_homecombo where thang = 202401 and loai_kpi like 'Fiber%' group by ma_tb having count(ma_Tb) > 1 --and ma_tb not in 
...
select* from ttkd_Bsc.ct_bsc_homecombo where thang = 202310 and ma_nv = 'VNP019514'
...
select* from ttkd_bsc.tl_homecombo where thang = 202402 and ma_kpi =  'HCM_CT_CLUOC_001'
...
--    select *
    ...
    where loai_kpi like 'Fiber_%' and thang = 202402 and ma_pb is not null
...
insert into ttkd_bsc.tl_homecombo
    ...
    where thang = 202402 and LOAI_TINH = 'KPI_NV' and  ma_kpi = 'HCM_CT_CLUOC_001' 
...
select* from ttkd_Bsc.tl_homecombo where thang = 202402-- and loai_tinh = 'KPI_PB'
commit;
...
insert into ttkd_bsc.tl_homecombo
    ...
    where a.thang = 202402 and LOAI_TINH = 'KPI_TO'  and  a.ma_kpi = 'HCM_CT_CLUOC_001' 

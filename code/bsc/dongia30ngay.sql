...
--select* from ttkd_bsc.ct_bsc_Tratruoc_moi_30day where thang = 202309 and rkm_id is not null and ma_pb not in ('VNP0702300', 'VNP0702400', 'VNP0702500')
        ...
        where xu.rkm_id is not null and xu.loaitb_id in (61, 171, 18) group by thang, khachhang_id)
            ...
            , SOTHANG_DC, HT_TRA_ONLINE, Khuvuc, dongia, DTHU, NGAY_TT, heso_giao, khdn, nhomtb_id, khachhang_id, heso, tien_khop, null, null
            from (
                    ...
                    , case 
                            ...
                            when sum(case when a.ht_tra_id in (1, 7,204) then 0
            ...
            , ttkd_bsc.nhanvien_202404 nv               -- chang    e
            ...
            and nvl(nv.ma_vtcv, 'khongco')  not in ('VNP-HNHCM_BHKV_18',
                                                    ...
                                                    'VNP-HNHCM_BHKV_18.1')
            ;   
select* from ttkd_bsc.ct_dongia_tratruoc where thang = 202402  and loai_tinh = 'DONGIATRA30D'
commit;
...
from ttkd_bsc.ct_dongia_tratruoc  a
where ma_kpi = 'DONGIA' 
        and loai_tinh = 'DONGIATRA30D' and thang = 202403
group by thang, loai_tinh, ma_kpi, ma_nv, ma_to, ma_pb
commit;
select * from ttkd_bsc.ct_dongia_Tratruoc  where loai_tinh = 'DONGIATRA30D' and thang = 202403 ;
select* from ttkd_bsc.tl_giahan_tratruoc where loai_tinh = 'DONGIATRA30D' and thang = 202403;
select* from css_hcm.db_thuebao where ma_tb  like '%91%'
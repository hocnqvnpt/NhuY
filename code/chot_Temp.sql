...
-- tao bang chot
select* from tmp3_ts; where ma_Tb = 'vanday5389166';
create table temp_trasau_chot as;
drop table tmp3_ts;
select* from khac_sdt where ma_Tb in (
    ...
    , kq_ghtt as (select 
              ...
              , p.thungan_tt_id, p.kenhthu_id, p.ht_tra_id, hdtb.tthd_id, hdkh.ngay_yc, p.thungan_hd_id,
               kt.kenhthu , nh.ten_nh ten_nganhang ,ht.ht_tra ten_ht_tra, 111 lan
                     from  css_hcm.hd_khachhang hdkh
													join css_hcm.hd_thuebao hdtb on hdkh.hdkh_id = hdtb.hdkh_id  and hdtb.kieuld_id in (551, 550, 24, 136,13080) and hdtb.tthd_id = 6
                     ...
                     hdtb.loaitb_id in (18, 58, 59, 61, 171, 210, 222, 224) and a.tien > 0 --and hdtb.thuebao_id = 8811198
                                      and  to_number(to_char(p.ngay_tt, 'yyyymm')) = 202405                   ----change--2 thang- ngay 02
...
commit;
select* from tmp3_ob where ma_Tb in ('vqthuylinh',
'ttd42',
'1675343',
'tn072022',
'ntcnhung-0320',
...
set ma_to = (select ma_to from ttkd_bsc.nhanvien_202405 where ma_nv = a.manv_Thuyetphuc),
ma_pb = (select ma_pb from ttkd_bsc.nhanvien_202405 where ma_nv = a.manv_Thuyetphuc)
where thang = 202405 and ma_to is null and ma_tb in ('vanthol1333769',
'vnpt-a16.27',
'nhancao_19',
'vanngockdcvl',
'bichhanh9140',
...
'tvan2',
'td9999');
select* from ttkd_bsc.nhuy_ct_bsc_ipcc_obghtt where thang = 202405 and ma_tb in ('vanthol1333769',
'vnpt-a16.27',
'nhancao_19',
'vanngockdcvl',
'bichhanh9140',

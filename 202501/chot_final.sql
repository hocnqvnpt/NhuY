...
and ma_to in (select distinct ma_to from ttkd_Bsc.nhanvien where thang = 202501 and ten_to = 'T? Bán Hàng Online');
...
(select DISTINCT ma_to from ttkd_Bsc.nhanvien where thang = 202501 and UPPER(ten_to) = 'T? BÁN HÀNG ONLINE');
COMMIT;

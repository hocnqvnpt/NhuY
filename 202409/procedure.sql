...
select* from tmp3_60ngay; where thuebao_id not in ( select a.thuebao_id from donhang_60ngay a join giao_202409 b on a.thuebao_id = b.thuebao_id and b.thang_kt = 202408);.ds_chungtu_nganhang_oneb;
select distinct ht_Tra_id from tmp3_60ngay;
--insert into ghtt_null_ngay_bddc
--insert into tmp3_60ngay
create table tmp3_60_ngay as
...
, gh as (select* from giao_202409 where thang_kt = 202408)             ---change n-1
...
, kq_ghtt as (select  hdkh.khachhang_id, hdtb.thuebao_id, 0 duan_id, hdtb.ma_tb, 'matt' ma_tt, hdtb.loaitb_id, gh.thang_kt, 22 as lan
...
--                                            left join ct2 on a.phieutt_id = ct2.phieu_id
                         where a.kenhthu_id not in (6) and a.trangthai = 1
                                        and to_number(to_char(a.ngay_tt, 'yyyymmdd')) between 20240701 and 20241001                  ----change--3 thang- ngay 2

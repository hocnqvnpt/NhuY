...
delete  from ttkd_bsc.ct_dongia_tratruoc where thang = 202409  and loai_tinh = 'DONGIATRU_CA' AND MA_KPI = 'DONGIA';
delete  from ttkd_bsc.tl_giahan_tratruoc where thang = 202409  and loai_tinh = 'DONGIATRU_CA' AND MA_KPI = 'DONGIA';
select* from ttkd_bsc.ct_bsc_giahan_cntt where thang= 202409 and ma_Tb in ('hcm_ca_ivan_00018004','hcm_ca_ivan_00018054','hcm_ca_ivan_00018096','hcm_ca_ivan_00018097',
...
COMMIT;
delete from ttkd_Bsc.ct_dongia_tratruoc where thang = 202409 and 'DONGIATRU_CA' = LOAI_TINh;
     ...
     a.thuebao_id, a.ma_tb 
                ,case 
                   ...
                   round((select sum(da_giahan_dung_hen)*100/sum(tong) 
                            from ttkd_Bsc.tl_giahan_tratruoc where thang = 202409 and ma_kpi = 'HCM_TB_GIAHA_024' and loai_tinh = 'KPI_NV'  and ma_nv = a.manv_giao),2) tyle
              from ttkd_bsc.ct_bsc_giahan_cntt a
                    where a.thang = 202409  and thang_ktdc_cu = 202409  and loaitb_id  in (55 ,80 ,116 ,117,132,140,154,181,288,318 ) -- and ma_Tb in ('hcm_ca_00039226','hcm_ca_00055400')     ------------n------------
                 ...
                 left   join ttkd_bsc.nhanvien nv on a.manv_giao = nv.ma_nv and nv.thang = 202409 and nv.donvi = 'TTKD';
...
where thang = 202409 AND LOAI_TINH = 'DONGIATRU_CA' AND MA_KPI = 'DONGIA' and a.ma_nv in 
(Select ma_nv from ttkd_bsc.nhanvien where ma_vtcv not in ('VNP-HNHCM_BHKV_6','VNP-HNHCM_KHDN_3','VNP-HNHCM_KHDN_18', 'VNP-HNHCM_BHKV_41') and thang=202409 and donvi = 'TTKD' )
    and ghichu is  null;

update TTKD_bSC.ct_dongia_tratruoc set dongia = 0 where ghichu is not null and thang = 202409 and loai_tinh = 'DONGIATRU_CA';
rollback;
select* from ttkd_Bsc.ct_dongia_tratruoc where thang = 202403;
commit;
insert into 
select  202409 THANG, LOAI_TINH, MA_KPI, MA_NV, MA_TO, MA_PB, PHONG_QL, THUEBAO_ID, MA_TB, TIEN_DC_CU, MANV_GIAO, MA_NV_CN, MANV_THUYETPHUC, SOTHANG_DC, HT_TRA_ONLINE,
...
TIEN_THUYETPHUC, IPCC from ttkd_Bsc.ct_bsc_giahan_cntt where thang = 202404 and ma_Tb in ('hcm_ca_00054795',
'hcm_ca_00054801',
'hcm_ca_00054804',
'hcm_ca_00054810',
'hcm_ca_00054814',
...
select* from ttkd_bsc.ct_dongia_tratruoc where tien_Dc_Cu is  null and loai_tinh ='DONGIATRU_CA' AND thang = 202409;
commit;
insert into  ttkd_Bsc.ct_dongia_Tratruoc
select  202409 THANG, LOAI_TINH, MA_KPI, MA_NV, MA_TO, MA_PB, PHONG_QL, THUEBAO_ID, MA_TB, TIEN_DC_CU, MANV_GIAO, MA_NV_CN, MANV_THUYETPHUC, SOTHANG_DC, HT_TRA_ONLINE,
KHUVUC, -DONGIA, DTHU, NGAY_TT, HESO_GIAO, KHDN, NHOMTB_ID, KHACHHANG_ID, HESO_DICHVU, TIEN_KHOP,'boi hoan don gia tru t6 theo VB 245' GHICHU, TYLE_THANHCONG, HESO_CHUKY, NHANVIEN_XUATHD, TIEN_XUATHD,
...
update table;
select* from ttkd_Bsc.ct_Dongia_tratruoc where thang = 202409 and ma_nv = 'VNP017748';
select* from ttkd_Bsc.ct_bsc_giahan_Cntt where thang = 202409 and manv_giao = 'VNP027256';

-- update 
s
commit;
update ttkd_Bsc.nhanvien set ten_Vtcv = 'Chuyên Viên Kinh Doanh (Am)' where thang = 202409 and ma_vtcv ='VNP-HNHCM_KHDN_3';
delete ;
SELECT* FROM TTKD_BSC.NHANVIEN where ten_nv like '%Thúy';
...
where a.thang = 202409 and loai_tinh = 'DONGIATRU_CA' and a.dongia != 0;and b.ma_vtcv = 'VNP-HNHCM_BHKV_6'; and a.dongia != 0 ;and ma_Nv ='VNP028833';
...
where ma_kpi = 'DONGIA' 
        and loai_tinh = 'DONGIATRU_CA' and thang = 202409
group by thang, loai_tinh, ma_kpi, ma_nv, ma_to, ma_pb  ;
commit;

select* from ttkd_Bsc.ct_dongia_Tratruoc where thang = 202409 and ma_Nv= 'VNP017796';
select* from ttkd_Bsc.ct_Bsc_Giahan_cntt where thang = 202409 and manv_Giao= 'VNP017796';
delete from ttkd_bsc.tl_giahan_tratruoc a
where loai_tinh = 'DONGIATRU_CA' and a.thang = 202409 ;
select * from ttkd_bsc.tl_giahan_tratruoc a
where loai_tinh = 'DONGIATRU_CA' and a.thang = 202409 ;and tien != 0;
select* from ct_Bsc_chungtu where thang = 202409 and tra_truoc  =1 and ma_gd like 'HCM-LD%';
update  ttkd_bsc.tl_giahan_tratruoc set tien = 0  where ma_nv ='VNP029065' and loai_tinh = 'DONGIATRU_CA' and thang = 202409;
...
delete;
update  ttkd_Bsc.tl_giahan_tratruoc set tien = 0 where thang = 202409  and loai_tinh = 'DONGIATRU_CA' and ma_Nv = 'VNP029065';;
commit;
select distinct loai_tinh, ma_kpi from ttkd_Bsc.tl_giahan_tratruoc where thang = 202409  and loai_tinh = 'DONGIATRU_CA' ;
select* from  ttkd_Bsc.tl_giahan_tratruoc where thang = 202409 and ma_kpi = 'THUHOI_BSC_DONGIA';
...
select SUM( TIEN )
from tl_giahan_Tratruoc where loai_tinh = 'DONGIATRU' AND MA_KPI = 'DONGIA_CA';    
SELECT DISTINCT TEN_vTCV FROM NHANVIEN_202409 WHERE MA_nV IN (SELECT MA_nV FROM TTKD_BSC.TL_GIAHAN_TRATRUOC WHERE THANG = 202409 AND loai_Tinh ='DONGIATRU_CA' AND TIEN!=0);